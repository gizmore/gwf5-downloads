...
final class GWF_Download extends GDO
{
	...
	public function gdoColumns()
	{
		return array(
			...
			GDO_DateTime::make('dl_accepted')->editable(false),
			GDO_User::make('dl_acceptor')->editable(false),
...
// 		}
	...
	{
		return self::table()->countWhere("dl_deleted IS NULL AND dl_accepted IS NOT NULL");
	}
}
